"""
 Python Example for Querying Scan Results by Scan ID
...
API Reference: https://pan.dev/prisma-airs/api/get-scan-results-by-scan-i-ds/
"""
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Query scan results by Scan ID using the Palo Alto Networks AI Security API.",
        epilog="Example: python3 scanresults.py 00000000-0000-0000-0000-000000000000",
        formatter_class=argparse.RawTextHelpFormatter
    )
    parser.add_argument(
        'scan_id',
        help="The Scan ID to query. This is returned from the AIRS endpoint."
    )
    ...
    scanner = Scanner()
    try:
        print(f"Querying results for Scan ID: {args.scan_id}...")
        ...
        scan_by_ids_response = await scanner.query_by_scan_ids(scan_ids=[args.scan_id])
